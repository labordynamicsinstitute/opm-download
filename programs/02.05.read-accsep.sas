...
%readin_data(accsep=accessions,year=2012,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_csv);
%readin_data(accsep=accessions,year=2011,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_csv);
%readin_data(accsep=accessions,year=2010,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_csv);
%readin_data(accsep=accessions,year=2009,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_45);
%readin_data(accsep=accessions,year=2008,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_45);
%readin_data(accsep=accessions,year=2007,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_45);
%readin_data(accsep=accessions,year=2006,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_45);
%readin_data(accsep=accessions,year=2005,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_45);

/* now do separations */
%readin_data(accsep=separations,year=2013,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_csv);
%readin_data(accsep=separations,year=2012,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_csv);
%readin_data(accsep=separations,year=2011,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_csv);
%readin_data(accsep=separations,year=2010,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_csv);
%readin_data(accsep=separations,year=2009,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_45);
%readin_data(accsep=separations,year=2008,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_45);
%readin_data(accsep=separations,year=2007,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_45);
%readin_data(accsep=separations,year=2006,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_45);
%readin_data(accsep=separations,year=2005,infmtlib=OPMFMT,outputs=YEARLY,layout=acc_45);
